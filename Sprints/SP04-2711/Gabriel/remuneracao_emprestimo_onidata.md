...
sequenceDiagram
    ...
    Processo->>Parametros: Seleciona indicadores de empréstimos da empresa ONIDATA.

    Processo->>Emprestimo: Seleciona dados de remuneração dos empréstimos da empresa ONIDATA.
